                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        ...
                                                        <div class="form-group row mb-4">
                                                            ...
                                                            <label class="col-md-4 col-form-label" for="redirect_stream">Direct Source <i data-toggle="tooltip" data-placement="top" title="" data-original-title="Don't run source through Xtream Codes, just redirect instead." class="mdi mdi-information"></i></label>
                                                            <div class="col-md-2">
                                                                <input name="redirect_stream" id="redirect_stream" type="checkbox" <?php if (isset($rStream)) { if ($rStream["redirect_stream"] == 1) { echo "checked "; } } ?>data-plugin="switchery" class="js-switch" data-color="#039cfd"/>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row mb-4">
