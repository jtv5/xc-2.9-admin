...
function decrypt_config($data, $key="5709650b0d7806074842c6de575025b1") {
    $i = 0;
    $output = '';
...
if (file_exists(IPTV_PANEL_DIR . "config")) {
	$_INFO = json_decode(decrypt_config(base64_decode(file_get_contents(IPTV_PANEL_DIR . "config"))), true);
